defmodule PlantAidWeb.UserAuth do
  use PlantAidWeb, :verified_routes
  ...
  the current_user:
      ...
      defmodule PlantAidWeb.PageLive do
        use PlantAidWeb, :live_view

        on_mount {PlantAidWeb.UserAuth, :mount_current_user}
        ...
      end

  Or use the `live_session` of your router to invoke the on_mount callback:

      live_session :authenticated, on_mount: [{PlantAidWeb.UserAuth, :ensure_authenticated}] do
