defmodule PlantAid.LocationsTest do
  ...
  describe "locations" do
    ...
    import PlantAid.LocationsFixtures
    ...
    test "create_location/1 with valid data creates a location" do
      ...
      assert location.position == "some position"
    end
    ...
    test "update_location/2 with valid data updates the location" do
      ...
      assert location.position == "some updated position"
    end
